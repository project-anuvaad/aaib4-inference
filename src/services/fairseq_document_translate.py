...
class NMTTranslateService:
    ...
    def batch_translator(input_dict):
        ...
        src_language, tgt_language = .get_src_tgt_langauge(model_id)
        ...
        try:
            for i,sent in enumerate(src_list):
                ...
                input_sentence = .convert_digits_preprocess(src_language,input_sentence)
            ...
            for i in range(num_sentence):
                ...
                tgt_list[i] = .convert_digits_postprocess(tgt_language,tgt_list[i])
